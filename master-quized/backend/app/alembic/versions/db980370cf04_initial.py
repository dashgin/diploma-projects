...
def upgrade():
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["area_id"], ["knowledge_area.id"], ondelete="SET NULL"
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "question_type", sqlmodel.sql.sqltypes.AutoString(length=15), nullable=False
        ),
        ...
        sa.Column(
            "ai_guidance", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
        sa.ForeignKeyConstraint(
            ["area_id"], ["knowledge_area.id"], ondelete="SET NULL"
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["assignment_id"], ["quiz_assignment.id"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(["quiz_id"], ["quiz.id"], ondelete="CASCADE"),
        sa.ForeignKeyConstraint(["student_id"], ["auth_user.id"], ondelete="CASCADE"),
        sa.PrimaryKeyConstraint("id"),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["attempt_id"], ["student_attempt.id"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(
            ["question_id"], ["quiz_question.id"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(
            ["selected_option_id"], ["question_option.id"], ondelete="SET NULL"
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_table(
        ...
        sa.Column(
            "error_type", sqlmodel.sql.sqltypes.AutoString(length=50), nullable=True
        ),
        sa.Column("confidence_score", sa.Float(), nullable=True),
        sa.Column(
            "feedback_content", postgresql.JSONB(astext_type=sa.Text()), nullable=False
        ),
        sa.Column(
            "ai_metadata", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
        sa.ForeignKeyConstraint(
            ["response_id"], ["student_response.id"], ondelete="CASCADE"
        ),
        sa.PrimaryKeyConstraint("id"),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["feedback_id"], ["ai_feedback.id"], ondelete="CASCADE"
        ),
        sa.PrimaryKeyConstraint("id"),
    )
