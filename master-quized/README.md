...
2. Set up environment variables (see .env.example files in each component)
3. Run `docker-compose up -d` to start all services
4. Access the application at http://localhost:3000

## Contributing

Contributions to QuizEd are welcome! Please check the contributing guidelines before submitting pull requests.
