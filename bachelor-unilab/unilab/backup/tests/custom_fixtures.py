...
def create_users_students(db, django_user_model):
    student1 = django_user_model.objects.create_user(
    ...
    student3 = django_user_model.objects.create_user(
...
def create_users_companies(db, django_user_model):
    company1 = django_user_model.objects.create_user(
    ...
    company2 = django_user_model.objects.create_user(
    ...
    company3 = django_user_model.objects.create_user(
...
def create_users_admins(db, django_user_model):
    admin1 = django_user_model.objects.create_user(
    ...
    admin2 = django_user_model.objects.create_user(
    ...
    admin3 = django_user_model.objects.create_user(
...
def create_companies(db, create_users_admins, create_users_companies):
    admin_company1 = Company.objects.create(
        name="Admin Comp 1",
    ...
    admin_company2 = Company.objects.create(
        name="Admin Comp 2",
        description="The company of an admin",
        video_url="https://www.youtube.com/watch?v=5qap5aO4i9A&ab_channel=LofiGirl",
        website_url="https://www.youtube.com",
    ...
    admin_company3 = Company.objects.create(
        name="Admin Comp 3",
        description="The company of an admin",
        video_url="https://www.youtube.com/watch?v=5qap5aO4i9A&ab_channel=LofiGirl",
        website_url="https://www.youtube.com",
    ...
    company_company1 = Company.objects.create(
        name="Company Comp 1",
    ...
    company_company2 = Company.objects.create(
        name="Company Comp 2",
        description="The company of a company",
        video_url="https://www.youtube.com/watch?v=Boj9eD0Wug8&ab_channel=YuvalNoahHarari",
        website_url="https://www.django-rest-framework.org/api-guide/relations/",
    ...
    company_company3 = Company.objects.create(
        name="Company Comp 3",
        description="The company of a company",
        video_url="https://www.youtube.com/watch?v=Boj9eD0Wug8&ab_channel=YuvalNoahHarari",
        website_url="https://www.django-rest-framework.org/api-guide/relations/",
    ...
    return {
        "companies": {
            "admins": [admin_company1, admin_company2, admin_company3],
            "companies": [company_company1, company_company2, company_company3],
        },
...
def create_jobs(db, create_companies):
    ...
    company_job1 = Job.objects.create(
        name="Programmer",
    ...
    company_job2 = Job.objects.create(
    ...
    company_job3 = Job.objects.create(
        name="Project Lead",
    ...
    return {
        "jobs": {
            "admins": [admin_job1, admin_job2, admin_job3],
...
def create_posts(
    ...
    django_user_model,
    create_users_admins,
    create_users_companies,
    create_users_students,
):
    admin_post1 = Post.objects.create(
        title="admin title 1",
    ...
    admin_post2 = Post.objects.create(
        title="admin title 2",
        content="Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor "
        "invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua",
        owner=create_users_admins[1],
    ...
    admin_post3 = Post.objects.create(
        title="admin title 3",
        content="Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor "
        "invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua",
        owner=create_users_admins[2],
    ...
    company_post1 = Post.objects.create(
    ...
    company_post2 = Post.objects.create(
    ...
    company_post3 = Post.objects.create(
        title="company title 3",
        content="Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor "
        "invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua",
        owner=create_users_companies[2],
        image=str(Path("../media/img4.jpg")),
    ...
    student_post1 = Post.objects.create(
    ...
    student_post2 = Post.objects.create(
        title="student title 2",
        content="Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor "
        "invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua",
        owner=create_users_students[1],
        image=str(Path("../media/img6.jpg")),
    )
    student_post3 = Post.objects.create(
        title="student title 2",
        content="Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor "
        "invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua",
...
def create_comments(db, django_user_model, create_posts):
    ...
    # - Self commenting
    admin1_on_admin1_comment = Comment.objects.create(
        content="I'm admin1, and I comment on my own post",
    ...
    # - Self commenting
    company1_on_company1_comment = Comment.objects.create(
        content="I'm company1, and I comment on my own post",
        owner=users["companies"][0],
    ...
    # - Self commenting
    student1_on_student1_comment = Comment.objects.create(
        content="I'm student1, and I comment on my own post",
        owner=users["students"][0],
    ...
    return {
        "comments": {
            "admin_post": [
                admin1_on_admin1_comment,
                admin2_on_admin1_comment,
                company1_on_admin2_comment,
                student1_on_admin3_comment,
            ],
            "company_post": [
                company1_on_company1_comment,
                company2_on_company1_comment,
                admin1_on_company2_comment,
                student1_on_company3_comment,
            ],
            "student_post": [
                student1_on_student1_comment,
                student2_on_student1_comment,
                admin1_on_student2_comment,
