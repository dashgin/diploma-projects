...
urlpatterns += [
    ...
    path('api/companies/choices',
         views.CompanyChoices.as_view(), name='job-choices'),

    path('api/company-pictures', views.CompanyPicturesList.as_view(),
         name='companypictures-list'),
    path('api/company-pictures/<int:pk>',
         views.CompanyPicturesDetail.as_view(), name='companypictures-detail'),

    path('api/users', views.UserList.as_view(), name='user-list'),
    path('api/users/<int:pk>', views.UserDetail.as_view(), name='user-detail'),

    path('api/user-data', views.UserDataList.as_view(), name='userdata-list'),
    path('api/user-data/<int:pk>',
         views.UserDataDetail.as_view(), name='userdata-detail'),

    path('api/education-data', views.EducationDataList.as_view(),
         name='educationdata-list'),
    path('api/education-data/<int:pk>',
         views.EducationDataDetail.as_view(), name='educationdata-detail'),

    path('api/vote', views.VoteList.as_view(), name='vote-list'),
    path('api/vote/<int:pk>', views.VoteDetail.as_view(), name='vote-detail'),

    path('api/experience-data', views.ExperienceDataList.as_view(),
         name='experiencedata-list'),
    path('api/experience-data/<int:pk>',
         views.ExperienceDataDetail.as_view(), name='experiencedata-detail'),

    path('api/skill-data', views.SkillDataList.as_view(), name='skilldata-list'),
    path('api/skill-data/<int:pk>',
         views.SkillDataDetail.as_view(), name='skilldata-detail'),
    ...
    path('api/post-report/<int:pk>',
         views.PostReportDetail.as_view(), name='postreport-detail'),
