# Generated by Django 3.2.4 on 2022-10-21 17:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='university_courses', to='api.userdata')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='university_admins', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='admins',
            field=models.ManyToManyField(blank=True, related_name='university_admin_set', through='api.UniversityAdmin', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='university',
            name='owner',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='owner_universities', to=settings.AUTH_USER_MODEL),
        ),
        migrations.CreateModel(
            name='SkillData',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('applicants', models.ManyToManyField(blank=True, related_name='job', through='api.Application', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='external_profiles', to='api.userdata')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='company_admins', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.AddField(
            model_name='company',
            name='admins',
            field=models.ManyToManyField(blank=True, through='api.CompanyAdmin', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='company',
            name='owner',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='certifications', to='api.userdata')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='user',
            name='university',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='students', to='api.university'),
        ),
        migrations.AddField(
            model_name='user',
